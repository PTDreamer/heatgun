...
enum {screen_splash, screen_main, screen_settings, screen_last_scrollable, screen_debug, screen_edit_cooldown, screen_edit_sleep, screen_edit_contrast, screen_edit_calibration_wait, screen_edit_calibration_input, screen_LAST};
